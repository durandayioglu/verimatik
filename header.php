...
<head>
    ...
    <title>Verimatik - Online Veresiye Takip Sistemi</title>
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">VERİMATİK</a>
        </div>
        <!-- Top Menu Items -->
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    <a href="charts.html"><i class="glyphicon glyphicon-user"></i> Kayıtlı Müşteriler</a>
                </li>
                <li>
                    <a href="tables.html"><i class="fa fa-fw fa-table"></i> Tables</a>
                </li>
                <li>
                    <a href="forms.html"><i class="fa fa-fw fa-edit"></i> Hesaba Borç Ekle</a>
                </li>
                <li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        Ziyaret İletişim
                        <small>VERİMATİK Online Veresiye Takip Sistemi</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li class="active">
